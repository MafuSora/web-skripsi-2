# Generated by Django 4.1.4 on 2023-05-13 17:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='jadwal_seminar',
            fields=[
                ('id_jadwal', models.BigAutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='mahasiswa',
            fields=[
                ('nim', models.BigIntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_topik', models.FileField(storage=gdstorage.storage.GoogleDriveStorage(), upload_to='topik_mahasiswa/')),
                ('keterangan', models.TextField(blank=True)),
                ('tanggal_buat', models.DateTimeField(auto_now_add=True)),
                ('tanggal_update', models.DateTimeField(auto_now=True)),
                ('nim', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='skripsi_app.mahasiswa')),
                ('permintaan_dosen_1', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='skripsi_app.dosen')),
            ],
        ),
        migrations.CreateModel(
            name='sub_cpmk',
            fields=[
                ('id_sub_cpmk', models.CharField(max_length=60, primary_key=True, serialize=False, validators=[django.core.validators.RegexValidator('^\\S+$', 'Tidak boleh memiliki spasi')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nama_tahap', models.CharField(choices=[('Proposal Awal', 'Proposal Awal (BAB 1 - BAB 3)'), ('Proposal Awal (Revisi Seminar Proposal)', 'Proposal Awal (BAB 1 - BAB 3) Revisi Seminar Proposal'), ('Laporan Akhir', 'Laporan Akhir (BAB 1 - BAB 5)'), ('Laporan Akhir (Revisi Seminar Hasil)', 'Laporan Akhir (BAB 1 - BAB 5) Revisi Seminar Hasil')], max_length=60)),
                ('judul_proposal', models.CharField(max_length=60)),
                ('file_proposal', models.FileField(storage=gdstorage.storage.GoogleDriveStorage(), upload_to='proposal_mahasiswa/')),
                ('keterangan', models.TextField(blank=True)),
                ('tanggal_buat', models.DateTimeField(auto_now_add=True)),
                ('tanggal_update', models.DateTimeField(auto_now=True)),
                ('nim', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='skripsi_app.mahasiswa')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tanggal_buat', models.DateTimeField(auto_now_add=True)),
                ('tanggal_update', models.DateTimeField(auto_now=True)),
                ('id_detail_penilaian', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='skripsi_app.detailpenilaian')),
                ('id_sub_cpmk', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='skripsi_app.sub_cpmk')),
            ],
        ),
        migrations.CreateModel(
